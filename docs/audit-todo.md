...
- refreshed overlay compare is now `306 / 420 full matches` / `114 mismatches` / `58 metadata drifts`
...
- next ready non-blocked compare-open case: `D192 Radio.GuardInterval`
