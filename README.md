...
9. `wifi_llapi` 目前已固化 102 筆 trusted/calibrated cases，尚餘 313 筆待校正；`D037 OperatingStandard` 仍為 blocked。
...
4. Copilot SDK 第三次重構研究：`docs/copilot-sdk-hooks-skills-session-resume-persistenc.md`
