...
- active audit RID is `74ada64b-2026-05-07T134956Z` against local-only workbook `audit/0506.xlsx`; current buckets are `confirmed=160`, `applied=8`, `pending=113`, `block=134`, `needs_pass3=0`
...
- active blockers now include the workbook/audit bucket blockers from this RID plus D006/D009/D012/D013/D014/D015/D016/D017/D021/D022/D024/D025/D026/D028/D034/D035/D037/D039/D041/D043/D044/D045/D046/D047: `134` blocked cases (`103` ambiguous workbook rows, `7` missing workbook rows, `24` source/live/lab/workbook authority, setup, scope, or projection conflicts); no D004/D018/D019/D020/D023/D029/D036/D038/D040/D042/D048/D049/D050 blocker remains after closure
- next ready single-case Pass3 target is `D051` (`pass3_pending_source_survey_required`); `D005`, `D007`, `D010`, `D011`, `D023`, `D029`, `D036`, `D038`, `D040`, `D042`, `D048`, `D049`, `D050`, and pass1-confirmed `D027` are in the confirmed bucket
- latest D050 validation: focused `testpilot wifi_llapi --case D050 --dut-fw-ver BGW720-0410-VERIFY` -> `1 passed / 0 failed`, `Pass / N/A / N/A`, compare `full_match_count=1` / `mismatch_case_count=0` against workbook row 50 `Pass / Not Supported / Not Supported`; no YAML edit applied because current authored 5G path plus N/A projections already match workbook normalization
