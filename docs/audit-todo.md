...
- refreshed overlay compare is now `308 / 420 full matches` / `112 mismatches` / `58 metadata drifts`
...
- next ready non-blocked compare-open case: `D194 Radio.HeCapsSupported`
