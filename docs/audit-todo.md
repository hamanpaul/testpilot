...
- blocker-style handoff now lives at `plugins/wifi_llapi/reports/D204_block.md`; compare is now `321 / 420 full matches` / `99 mismatches` / `58 metadata drifts`, and the next ready non-blocked compare-open case moves to `D209 Radio.OperatingChannelBandwidth`
...
- refreshed overlay compare is now `321 / 420 full matches` / `99 mismatches` / `58 metadata drifts`
...
- next ready non-blocked compare-open case: `D209 Radio.OperatingChannelBandwidth`
