...
- active blockers now include the workbook/audit bucket blockers from this RID plus D006/D009/D012/D013/D014/D015/D016/D017/D021/D022/D024/D025/D026/D028/D034/D035/D037/D039/D041/D043/D044: `131` blocked cases (`103` ambiguous workbook rows, `7` missing workbook rows, `21` source/live/lab/workbook authority, setup, scope, or projection conflicts); no D004/D018/D019/D020/D023/D029/D036/D038/D040/D042 blocker remains after closure
- next ready single-case Pass3 target is `D045` (`pass3_pending_source_survey_required`); `D005`, `D007`, `D010`, `D011`, `D023`, `D029`, `D036`, `D038`, `D040`, `D042`, and pass1-confirmed `D027` are in the confirmed bucket
- latest D044 validation: focused `testpilot wifi_llapi --case D044 --dut-fw-ver BGW720-0410-VERIFY` -> `0 passed / 1 failed`, `Fail / N/A / N/A`, compare `full_match_count=0` / `mismatch_case_count=1` against workbook row 44 `Pass / Pass / Pass`; blocker is stale case-local WPA3/SAE `sta_env_setup[48]` plus checked-in 5G-only scope, both outside audit allowlist
