...
9. `wifi_llapi` 全部 420 筆 official cases 已校正完畢（343 Support + 54 Not Supported + 20 Skip + 3 Blocked）；僅餘 3 筆 Blocked（`D037 OperatingStandard`、`D054 Tx_RetransmissionsFailed`、`D055 TxBytes`）因環境/BCM 限制暫時無法驗證。
