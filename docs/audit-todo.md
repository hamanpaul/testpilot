...
- blocker-style handoff now lives at `plugins/wifi_llapi/reports/D204_block.md`; compare is now `319 / 420 full matches` / `101 mismatches` / `58 metadata drifts`, and the next ready non-blocked compare-open case moves to `D207 Radio.ObssCoexistenceEnable`
...
- refreshed overlay compare is now `319 / 420 full matches` / `101 mismatches` / `58 metadata drifts`
...
- next ready non-blocked compare-open case: `D207 Radio.ObssCoexistenceEnable`
