...
- active audit RID is `74ada64b-2026-05-07T134956Z` against local-only workbook `audit/0506.xlsx`; current buckets are `confirmed=155`, `applied=8`, `pending=125`, `block=127`, `needs_pass3=0`
...
- active blockers now include the workbook/audit bucket blockers from this RID plus D006/D009/D012/D013/D014/D015/D016/D017/D021/D022/D024/D025/D026/D028/D034/D035/D037: `127` blocked cases (`103` ambiguous workbook rows, `7` missing workbook rows, `17` source/live/lab/workbook authority, setup, scope, or projection conflicts); no D004/D018/D019/D020/D023/D029/D036 blocker remains after closure
- next ready single-case Pass3 target is `D039` (`pass3_pending_source_survey_required`); `D005`, `D007`, `D010`, `D011`, `D023`, `D029`, `D036`, `D038`, and pass1-confirmed `D027` are in the confirmed bucket
