...
- Trusted/calibrated official cases: **180 / 415**
- Remaining official cases: **235**
- Active blockers:
...
- Continuation guard rails:
  ...
  - `D185` / `D368` / `D371` 已從待校正池移出並折入完成數；最新 main-sweep checkpoint 則前進到 `D119`，下一個 ready sequential case 為 `D120`
