...
- active audit RID is `74ada64b-2026-05-07T134956Z` against local-only workbook `audit/0506.xlsx`; current buckets are `confirmed=151`, `applied=1`, `pending=147`, `block=116`, `needs_pass3=0`
...
- active blockers now include the workbook/audit bucket blockers from this RID plus D006/D009/D012/D013/D014/D015: `116` blocked cases (`103` ambiguous workbook rows, `7` missing workbook rows, `6` source/live/lab/workbook authority conflicts); no D004 blocker remains after the reboot/retry closure
- next ready single-case Pass3 target is `D016` (`pass3_pending_no_workbook_extract`); `D005` and `D007` are already in the confirmed bucket (`pass1_verdict_match`)
